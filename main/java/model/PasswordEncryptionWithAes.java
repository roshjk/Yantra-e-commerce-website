...
public class PasswordEncryptionWithAes {
	...
	public static String decrypt(String encryptedPassword, String user_id) {
		try {
			...
			SecretKey aesKeyFromPassword = PasswordEncryptionWithAes.getAESKeyFromPassword(user_id.toCharArray(), salt);
